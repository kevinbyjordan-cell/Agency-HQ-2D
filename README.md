...
🟡 **Fase de design concluída.** Próximo passo: plano de implementação da Fase 1.

Documento de design: [`docs/superpowers/specs/2026-06-18-agency-hq-2d-office-design.md`](docs/superpowers/specs/2026-06-18-agency-hq-2d-office-design.md)
...
- **Servidor/watcher:** Node + TypeScript (`chokidar` + `ws`)
- **Front-end:** Vite + TypeScript, DOM/SVG puro
- **Execução:** local — `npm run dev`, abrir `http://localhost:4500`
